            ...
            <form onSubmit={handleSubmit(onSubmitForm)}>
                <div className='form-group mb-3'>
                    ...
                    <select id="cats" className="form-select form-select-sm">
                        ...
                        <div className="form-group mb-3">
                            <lable htmlFor="detail">รายละเอียดสินค้า *</lable>
                        ...
                        <div className="form-group mb-3">
                            <lable htmlFor="price">วันที่เพิ่มสินค้า *</lable>
                            <input type="date" id="dateAdded" name="dateAdded"
                                className="form-control form-control-sm"/>
                        </div>
                        <div className="form-group mb-3">
                            <lable htmlFor="file" className="form-lable">ภาพสินค้า * (ไม่เกิน 3 ไฟล์
                            ขนาดสูงสุด 300 KB/ไฟล์)</lable>
